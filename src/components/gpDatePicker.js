...
handleClick=(event)=>{
  ...
  console.log(new Date(this.state.startDate));
    return (
      ...
      /><img  id={this.props.id} src={calendar} onClick={this.toggle} alt={this.props.value} style={style}/>
      <i style={style} onClick={this.handleClear}  alt={this.props.value} ><FaWindowClose/></i>
      </React.Fragment>
    );
   }
